...
class AntiSpoofingMetric(mx.metric.EvalMetric):
    """AntiSpoofing metric for nir flow classify task.
    ...
    def __init__(self, dataset, save_prefix, use_time=True, cleanup=False,
                 data_shape=None):
        super(AntiSpoofingMetric, self).__init__('AntiSpoofingRecall')

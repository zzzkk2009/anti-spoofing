...
int main(int argc, char* argv[]) {
	...
	std::string json_file = "./src/net/model/mx-flow-shuffle/checkpoint-symbol.json";
	std::string param_file = "./src/net/model/mx-flow-shuffle/checkpoint-0060.params";
	std::string synset_file = "./src/net/model/mx-flow-shuffle/synset.txt";

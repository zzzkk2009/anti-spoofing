...
//	string symbol_file = prefix + "checkpoint32/checkpoint-symbol.json";
//	string params_file = prefix + "checkpoint32/checkpoint-0300.params";
...
//				try
//				{
//					/*calcOpticalFlowFarneback(prevgray, ir_gray, ir_flow, 0.5, 3, 15, 3, 5, 1.2, 0);
...
//					int iResponse = predict(predictor, synsets, rgb_face_flow, label_synset_str);
//
